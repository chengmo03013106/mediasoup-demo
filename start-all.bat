...
REM
REM  Usage: double-click this script, or run start-all.bat in cmd
...
start "mediasoup-server" cmd /k "cd /d "%SERVER_DIR%" && set DEBUG=mediasoup-demo-server* *INFO* *WARN* *ERROR* && node lib/index.js"
